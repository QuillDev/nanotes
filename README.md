...
- **Global hotkey overlay** — <kbd>⌥</kbd>+<kbd>N</kbd> on macOS or <kbd>Alt</kbd>+<kbd>N</kbd> on Linux toggles a floating, always-on-top window over any app. Rebind it to any combo from settings.
